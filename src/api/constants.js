...
export const bahmniUrl = "https://abdm.dev.farmako.in";
export const hipServiceUrl = "https://abdm.dev.farmako.in/api/v1/partner/abha";

export const authModesUrl = "/link/getOptions";
...
export const existingPatientUrl = "/link/getOptions";
...
export const checkAndGenerateMobileOtp =
  "/v2/registration/aadhaar/checkAndGenerateMobileOTP";
export const verifyMobileOTP = "/v2/registration/aadhaar/verifyMobileOTP";
export const createHealthIdByAdhaar =
  "/v2/registration/aadhaar/createHealthIdByAdhaar";
...
export const mobileEmailPreverification =
...
export const globalPropertyUrl =
  "/openmrs/ws/rest/v1/bahmnicore/sql/globalproperty";
export const cmSuffixProperty = "bahmniHip.CM_SUFFIX";
export const enableHealthIdVerification =
  "bahmniHip.enableHealthIdVerification";
...
export const invalidHealthId = {
  error: {
    message:
      "Health Id/PHR Address is invalid. " +
