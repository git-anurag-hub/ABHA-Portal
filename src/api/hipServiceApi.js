...
export const getAuthModes = async (healthId) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.authModesUrl,
      data,
      Constants.headers
    );
    ...
    else return Constants.serviceUnavailableError;
  }
};
...
export const saveDemographics = async (healthId, ndhmDetails) => {
  const data = {
    ...
    phoneNumber: ndhmDetails.identifiers
      ? ndhmDetails.identifiers[0].value
      : null,
  };

  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.ndhmDemographics,
      data,
      Constants.headers
    );
    return response.data;
...
export const authInit = async (healthId, authMode) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.authInitUrl,
      data,
      Constants.headers
    );
    return response;
...
export const authConfirm = async (healthId, otp, demographics) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.authConfirmUrl,
      data,
      Constants.headers
    );
...
export const checkAndGetPatientDetails = async (healthId) => {
  try {
    const response = await axios.post(
      Constants.hipServiceUrl +
        Constants.getPatientForDirectAuthUrl +
        "?healthId=" +
        healthId,
      Constants.headers
    );
...
export const fetchPatientDetailsFromBahmni = async (patient) => {
  const params = {
    ...
    phoneNumber: encodeURI(
      patient?.identifiers !== undefined && patient?.identifiers.length > 0
  ...
  try {
    const response = await axios.get(
      Constants.bahmniUrl + Constants.existingPatientUrl,
      { params },
      Constants.headers
    );
    return response.data;
...
const isValidAuthMode = (authMode) => {
  if (authMode === "") return Constants.invalidAuthMode;
};

const isValidOTP = (otp) => {
  if (otp === "") return Constants.emptyOTP;
};

export const fetchPatientFromBahmniWithHealthId = async (healthId) => {
  try {
    const response = await axios.get(
      Constants.bahmniUrl + Constants.existingPatientUrl + "/" + healthId,
      Constants.headers
    );
    return response.data;
  } catch (error) {
...
export const getHealthIdStatus = async (patientUuid) => {
  try {
    const response = await axios.get(
      Constants.bahmniUrl +
        Constants.existingPatientUrl +
        "/IdDeactivationStatus/" +
        patientUuid,
      Constants.headers
    );
    return response.data;
...
export const getPatientQueue = async () => {
  try {
    const response = await axios.get(
      Constants.hipServiceUrl + Constants.patientProfileFetch
    );
    return response.data;
  } catch (error) {
    if (error.response !== undefined) return error.response.data;
...
export const saveTokenOnQRScan = async (ndhmDetails) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.authToken,
      data,
      Constants.headers
    );
    return response;
...
export const generateAadhaarOtp = async (aadhaar) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.generateAadhaarOtp,
      data,
      Constants.headers
    );
    return response;
...
export const verifyAadhaarOtp = async (otp) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.verifyAadhaarOtp,
      data,
      Constants.headers
    );
    return response;
...
export const generateMobileOtp = async (mobile) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.checkAndGenerateMobileOtp,
      data,
      Constants.headers
    );
    return response;
...
export const verifyMobileOtp = async (otp) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.verifyMobileOTP,
      data,
      Constants.headers
    );
    return response;
...
export const createABHA = async () => {
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.createHealthIdByAdhaar,
      Constants.headers
    );
    return response;
  } catch (error) {
...
export const getCard = async () => {
  try {
    const response = await axios.get(
      Constants.hipServiceUrl + Constants.getPngCard,
      {
...
export const mobileEmailInit = async (mobile) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.mobileEmailInit,
      data,
      Constants.headers
    );
    return response;
...
export const verifyOtpInput = async (otp, isHealthIdNumberOtp = false) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.mobileEmailPreverification,
      data,
      Constants.headers
    );
    return response;
...
export const getUserToken = async (phrAddress) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.getUserToken,
      data,
      Constants.headers
    );
    return response;
...
export const linkORUnlinkABHAAddress = async (action) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.linkABHAAddress,
      data,
      Constants.headers
    );
    return response;
...
export const getAuthMethods = async (healthIdNumber) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.authMethods,
      data,
      Constants.headers
    );
    return response;
...
export const createABHAAddress = async (phrAddress, preferred) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.createABHAAddress,
      data,
      Constants.headers
    );
    return response;
...
export const checkIfABHAAddressExists = async (phrAddress) => {
  try {
    const response = await axios.get(
      Constants.hipServiceUrl +
        Constants.checkIfABHAAddressExists +
        "?phrAddress=" +
        phrAddress,
      Constants.headers
    );
...
export const searchHealthId = async (healthId) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.searchHealthId,
      data,
      Constants.headers
    );
    return response;
...
export const healthIdAuthInit = async (healthId, authMode) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.healthIdAuthInit,
      data,
      Constants.headers
    );
    return response;
...
export const healthIdConfirmOtp = async (otp, authMode) => {
  ...
  try {
    const response = await axios.post(
      Constants.hipServiceUrl + Constants.healthIdConfirmOtp,
      data,
      Constants.headers
    );
    return response;
...
export const createDefaultHealthId = async () => {
  try {
    const response = await axios.get(
      Constants.hipServiceUrl + Constants.createDefaultHealthId,
      Constants.headers
    );
    return response;
  } catch (error) {
...
export const fetchPatientFromBahmniWithUuid = async (patientUuid) => {
  try {
    const response = await axios.get(
      Constants.bahmniUrl +
        Constants.existingPatientWithUuid +
        "/" +
        patientUuid,
      Constants.headers
    );
...
export const fetchGlobalProperty = async (property) => {
  try {
    const response = await axios.get(
      `${Constants.globalPropertyUrl}?property=${property}`
    );
    return response.data;
  } catch (error) {
    return Constants.openMrsDown;
