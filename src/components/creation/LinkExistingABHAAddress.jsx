  ...
  async function link() {
    ...
    if (response) {
      ...
      if (response.data === undefined) {
        ...
        if (response.data.success === "true") mapPatient();
        else {
  ...
  return (
    <div>
      {!isPatientMapped && (
        <div>
          <div className="abha">
            <label htmlFor="abha-number" className="label">
              ABHA Number
            </label>
            <div className="verify-abha-input-btn">
              <div className="verify-abha-input">
                <input
                  ...
                  id="abha-number"
                  name="abha-number"
                  value={props.patient.healthIdNumber}
                  disabled={true}
                />
              </div>
              <button
          ...
          {otpVerified && (
            <div className="center">
              <button type="button" className="proceed" onClick={link}>
                Proceed
              </button>
            </div>
          )}
