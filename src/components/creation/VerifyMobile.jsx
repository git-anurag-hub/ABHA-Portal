    ...
    if (mobile === "") {
      ...
      if (response) {
        ...
        if (response.data === undefined) {
          ...
          if (response.data?.mobileLinked === "true") setMobileLinked(true);
    ...
    if (response) {
      ...
      if (response.data === undefined) {
        ...
        if (props.mappedPatient.identifiers === undefined) {
          props.mappedPatient.identifiers =
            response.data?.mobile !== undefined
              ? [
                  {
  ...
  return (
    <div>
        ...
        <div>
          <div>
            ...
            <div className="message">
              This number will be used to authenticate your ABHA Number. It is
              recommended to use your AADHAAR linked mobile number
            </div>
          </div>
          {showOtpInput && (
            <VerifyOTP setOtp={setOtp} disabled={otpVerified || mobileLinked} />
          )}
            ...
            <div>
              {otpVerified && (
                <p className="note success">
                  <strong>OTP Verfied Successfully</strong>
                </p>
              )}
              {mobileLinked && (
                <p className="note success">
                  <strong>mobile already Linked </strong>
                </p>
              )}
            </div>
          )}
      ...
      {!proceed && abhaCreated && (
        <div>
          <p className="note success">
            <strong>ABHA Created Successfully</strong>
          </p>
          <p className="note">
