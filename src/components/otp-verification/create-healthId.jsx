...
const CreateHealthId = (props) => {
  ...
  return (
    <div>
      <p className="note">
        You don't have ABHA Address/ Health Id linked to your ABHA Number
      </p>
      <div>
        <div className="qr-code-scanner">
          <button
            name="default-healthId-btn"
            type="button"
            onClick={createDefault}
          >
            Create Default ABHA Address
          </button>
        </div>
        ...
        <div className="create-healthId">
          ...
          <div className="create-healthId-btn">
            ...
            <button type="button" onClick={createUserDefinedHealthId}>
              Create
            </button>
